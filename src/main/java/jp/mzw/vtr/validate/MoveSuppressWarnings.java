...
public class MoveSuppressWarnings extends Suggestion {

	protected File file;
	protected MethodDeclaration method;
	protected String warning;
	protected int lineno;
	public MoveSuppressWarnings(Project project, String commit,
	...
	public String toXml() {
		...
		builder.append("<Suggestion type=\"MoveSuppressWarnings\">");
