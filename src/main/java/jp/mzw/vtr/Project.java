...
public class Project {
	...
	public static Project make(Properties config) throws IOException {
		...
		Project project = new Project(new File(path_to_project))
				.setGitCompareBranchName(ref_to_compare)
				.setGithubConfig(github_username, github_projname);
	...
	public String getGithubUrl() {
		...
		builder.append("https://github.com/")
			.append(this.githubUserName).append("/")
			.append(this.githubProjName).append("/");
		return builder.toString();
	}
	public String getGithubUrlBlame(Commit commit, File file) {
		StringBuilder builder = new StringBuilder();
		builder.append(this.getGithubUrl()).append("blame/")
			.append(commit.getId()).append("/")
			.append(this.getRelativePath(file));
		return builder.toString();
	}
	...
	public String getGithubUrlBlob(Commit commit, String relative_path) {
		StringBuilder builder = new StringBuilder();
		builder.append(this.getGithubUrl()).append("blob/")
			.append(commit.getId()).append("/")
			.append(relative_path);;
		return builder.toString();
	}
